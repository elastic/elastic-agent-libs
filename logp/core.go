...
// ConfigureWithOutputs is required by elastic-agent to create a logger with
// multiple outputs. One is the default configurable output and the other is a
// file output used by the monitoring Beats.
// See: https://github.com/elastic/elastic-agent/blob/main/pkg/core/logger/logger.go
// for more details, look at the `new` and `MakeInternalFileOutput` functions from
// this file.
